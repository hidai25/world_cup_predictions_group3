...
Comment: Based on the graphs above, the predictors ranking, coach salary, and caps of each team
...
__Comment:__ The clean DataFrame after the unnecessary columns were dropped, various characters were striped from the columns where there were numbers, missing values were taken care of and only players originated from the countries of the world cup were used.
...
After we grouped the players by countries we averages the data of all the players belonging to each countries. These were the columns we used as predictors:
...
__comment:__ show players Potential distribution
