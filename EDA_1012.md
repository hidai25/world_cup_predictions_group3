...
__The data gathered was grouped by nation and averaged- Including all the countries participating:__
...
Comment: This plot show us the distribution of goal difference in each and every match we used for our training set.


__The 8 most played international tournaments:__

![png](EDA_1012_files/EDA_1012_18_1.png)

Comment: Since the different historical matches were used to train our model it was important for us
to see what type of tournament was the most frequent in our data. We can see that friendly matches
are the most frequent followed by the FIFA world cup matches.


__Show the countries with the most wins since 1990 for all these international games:__
...
A sample of the Fifa ranking table scraped from FIFA.com with only the squads participating:
