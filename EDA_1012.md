...
__Comment:__ The clean DataFrame after the unnecessary columns were dropped, various characters were striped from the columns where there were numbers, missing values were taken care of and only players originated from the countries of the world cup were used. It contains the following columns:
...
All of these were used as features.
